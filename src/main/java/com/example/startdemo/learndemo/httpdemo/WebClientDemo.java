package com.example.startdemo.learndemo.httpdemo;

import com.example.startdemo.learndemo.httpdemo.bean.Person;
...
public class WebClientDemo {
    public static void main(String[] args) {
        new CallPersonUsingWebClient_Step1();
    }
    public static class CallPersonUsingWebClient_Step1 {
